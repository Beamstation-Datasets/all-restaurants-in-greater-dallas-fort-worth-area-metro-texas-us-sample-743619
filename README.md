# All Restaurants in Greater Dallas-Fort Worth Area (Metro), Texas, US
...
| Full dataset size | 19,252 records |
| Free sample size | 1,000 records (5.19%) |
| Last export | 2026-04-09T13:01:51.015417+00:00 |
| Download | [Latest release asset](https://github.com/Beamstation-Datasets/all-restaurants-in-greater-dallas-fort-worth-area-metro-texas-us-sample-743619/releases/download/sample-latest/beamstation_743619_restaurants-us-dallasfortwortharlingtontx_SAMPLE_DIST.csv) |
...
Search for dataset ID `743619` on BeamStation if you want the exact commercial listing.
